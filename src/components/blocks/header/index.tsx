...
export default function Header({ header }: { header: HeaderType }) {
  ...
  return (
    <section className="sticky top-0 z-50 py-3 backdrop-blur-md">
      <div className="container">
        <nav className="duck-panel hidden items-center justify-between rounded-full px-5 py-3 lg:flex">
        ...
        <div className="block lg:hidden">
          <div className="duck-panel flex items-center justify-between rounded-full px-4 py-3">
            <Link
              href={(header.brand?.url || "/") as any}
              className="flex items-center gap-2"
            >
